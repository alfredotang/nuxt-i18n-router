...
<template>
  <div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <p
        class="my-4 p-4 text-gray-800 border border-dashed bg-white flex items-center justify-center flex-col"
      >
        <code class="bg-gray-100 text-sm p-1 rounded border">{{ subpath }}</code>
      </p>
